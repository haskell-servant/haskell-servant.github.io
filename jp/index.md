...
1. [A web API as a type](/tutorial/jp/0.4/api-type.html)
2. [Serving an API](/tutorial/jp/0.4/server.html)
3. [Deriving Haskell functions to query an API](/tutorial/jp/0.4/client.html)
4. [Generating javascript functions to query an API](/tutorial/jp/0.4/javascript.html)
5. [Generating documentation for APIs](/tutorial/jp/0.4/docs.html)
